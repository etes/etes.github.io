...
define(["dojo/has"], function (has) {
    ...
    has.add("customSearch", function (g) {
        var customSearch = g.config.customSearch || false;
        //overwrite the default with app settings
        /*if (g.config.hasOwnProperty("tool_search")) {
            search = g.config.tool_search;
        }*/
    ...
    has.add("download", function (g) {
        var download = g.config.download || false;
        //overwrite the default with app settings
        if (g.config.hasOwnProperty("tool_download")) {
            download = g.config.tool_download;
        }
        return download;
    });
